...
var require_siteMetadata = __commonJS({
  'config/siteMetadata.js'(exports, module) {
    var siteMetadata2 = {
      ...
      siteUrl: 'https://nextplate.netlify.app',
      base_path: '/',
...
async function generateSlugMap(allBlogs) {
  ...
  allBlogs.forEach((blog) => {
    ...
    const formattedLng =
      language === import_locales.fallbackLng
    ...
    if (file.tags && (!isProduction || file.draft !== true)) {
      file.tags.forEach((tag) => {
        ...
        if (file.language === import_locales.fallbackLng) {
          tagCount[import_locales.fallbackLng][formattedTag] =
            (tagCount[import_locales.fallbackLng][formattedTag] || 0) + 1
        } else if (file.language === import_locales.secondLng) {
          tagCount[import_locales.secondLng][formattedTag] =
            (tagCount[import_locales.secondLng][formattedTag] || 0) + 1
        }
      })
    }
  })
...
function createSearchIndex(allBlogs) {
  if (
    import_siteMetadata.default?.search?.provider === 'kbar' &&
    import_siteMetadata.default.search.kbarConfig.searchDocumentsPath
  ) {
    writeFileSync(
...
//# sourceMappingURL=compiled-contentlayer-config-HLJ3UH7S.mjs.map
