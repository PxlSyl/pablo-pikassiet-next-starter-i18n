...
var contentlayer_config_default = makeSource({
  contentDirPath: 'src/content/data/blog/',
  documentTypes: [Blog],
  mdx: {
    cwd: process.cwd(),
    remarkPlugins: [
    ...
    rehypePlugins: [
      ...
      rehypeKatex,
      [rehypeCitation, { path: path.join(root, 'src', 'content', 'data', 'blog') }],
...
//# sourceMappingURL=compiled-contentlayer-config-PW2Q3BD6.mjs.map
