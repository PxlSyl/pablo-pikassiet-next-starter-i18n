...
export const Pause: React.FC = (): JSX.Element => {
  return (
    <svg
      width="45"
      height="45"
...
export const SkipForward: React.FC = (): JSX.Element => {
  return (
    <svg
      width="28"
      height="28"
...
export const SkipBack: React.FC = (): JSX.Element => {
  return (
    <svg
      width="28"
      height="28"
...
export const Repeat: React.FC = (): JSX.Element => {
  return (
    <svg
      version="1.1"
      width="25"
...
export const RandomMusicsTrue: React.FC = (): JSX.Element => {
  return (
    <svg
      width="25"
      height="25"
...
export const Download: React.FC = (): JSX.Element => {
  return (
    <svg
      width="35"
      height="35"
...
export const VolumeOff: React.FC = (): JSX.Element => {
  return (
    <svg
      width="20"
      height="20"
...
export const VolumeOn: React.FC = (): JSX.Element => {
  return (
    <svg
      width="20"
      height="20"
...
export const All: React.FC = (): JSX.Element => {
  return (
    <svg
      width="25px"
      height="25px"
...
export const AllSelected: React.FC = (): JSX.Element => {
  return (
    <svg
      width="25px"
      height="25px"
...
export const SearchSelected: React.FC = (): JSX.Element => {
  return (
    <svg
      width="25"
      height="25"
