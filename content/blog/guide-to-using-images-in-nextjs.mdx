...
Assuming we have a file called `ocean.jpg` in `image/blog/ocean.jpg`, the following line of code would generate the optimized image.
...
```js
<Image alt="ocean" src="/images/blog/ocean.jpg" width={256} height={128} />
```
...
- All images have to be stored in the `public` folder e.g `/images/blog/ocean.jpeg`
